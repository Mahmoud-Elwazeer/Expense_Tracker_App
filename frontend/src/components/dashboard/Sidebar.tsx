...
import { X, BarChart3, CreditCard, ListTodo } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ sidebarOpen, setSidebarOpen }) => {
  const navigation = [
    { name: 'Expenses', href: '/dashboard', icon: CreditCard },
    { name: 'Categories', href: '/dashboard/categories', icon: ListTodo },
